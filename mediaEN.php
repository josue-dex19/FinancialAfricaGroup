    ...
    <div class="jumbotron">
        <div class="container " style="background-color: rgba(0, 0, 0, 0.63);">
            ...
            <div class="row">
                ...
                <ul class="disc">
                    <li>
                        <p> 17th OIC Trade Fair in Dakar: CICES ready to host the biggest trade event of the Islamic Ummah </p>
                    ...
                    <br>
                    <li>
                        <p>Morocco: Presentation of the 17th OIC Trade Fair in Dakar</p>
